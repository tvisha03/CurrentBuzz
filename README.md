...
<h2>Features</h2>
    <ul>
        ...
        <li><strong>User-friendly Interface:</strong> Clean, easy-to-navigate layout with interactive elements.</li>
        <li><strong>Search Functionality:</strong> Find specific news articles by keywords or topics.</li>
...
<h2>Technologies Used</h2>
    <ul>
        ...
        <li><strong>State Management:</strong> React hooks (<code>useState</code>, <code>useEffect</code>)</li>
 ...
 <h2>Installation</h2>
    <ol>
        ...
        <li>Navigate to the project folder:
            <pre><code>cd currentbuzz</code></pre>
        </li>
        <li>Install the required dependencies:
            <pre><code>npm install</code></pre>
        </li>
        <li>Create a <code>.env</code> file in the root directory and add your NewsAPI key:
            <pre><code>REACT_APP_NEWS_API_KEY=your_news_api_key_here</code></pre>
        </li>
